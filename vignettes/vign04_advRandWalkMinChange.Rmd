...
vignette: >
  %\VignetteIndexEntry{Vign04_advRandWalkMinChange}
...
```{r load various libraries 2, message=FALSE}
...
Annotation of the *test_4k* dataset with CHETAH.
...
Processing of the SingleCellExperiment object.
...
## 1   CD14+ Mono    0.421875             2         TRUE          16          NA
## 2   CD14+ Mono    0.421875             3         TRUE          15          NA
## 3 UNDETERMINED         0.5             4         TRUE          14          NA
## 4 UNDETERMINED         0.5             5         TRUE          12          NA
## 5 UNDETERMINED     0.53125             6         TRUE          11          NA
## 6 UNDETERMINED       0.625             7         TRUE           9          NA
##       S100A12    HLA.DQB1    HLA.DPA1    HLA.DPB1    HLA.DRB1      S100A8
##   <character> <character> <character> <character> <character> <character>
## 1          NA          NA          NA       perc1          NA          NA
## 2          NA          NA          NA       perc1          NA          NA
## 3          NA          NA          NA       perc1          NA          NA
## 4          NA          NA          NA       perc1          NA          NA
## 5          NA      perc99          NA       perc1          NA          NA
## 6       perc1      perc99          NA       perc1          NA          NA
##      HLA.DQA1      S100A9        CD74        VCAN     HLA.DMA        CTSS
##   <character> <character> <character> <character> <character> <character>
## 1          NA      perc99          NA          NA          NA          NA
## 2          NA      perc99          NA       perc1          NA          NA
## 3          NA       perc1          NA       perc1          NA          NA
## 4          NA       perc1          NA       perc1      perc99          NA
## 5          NA       perc1          NA      perc99      perc99          NA
## 6          NA       perc1          NA       perc1          NA          NA
...
##  [31] colorspace_2.1-0              AnnotationDbi_1.62.1         
...
##  [55] interactiveDisplayBase_1.38.0 httpuv_1.6.11                
##  [57] glue_1.6.2                    rhdf5filters_1.12.1          
##  [59] promises_1.2.0.1              grid_4.3.0                   
...
##  [99] uwot_0.1.14                   xtable_1.8-4                 
## [101] munsell_0.5.0                 Rcpp_1.0.10                  
## [103] bioDist_1.72.0                dbplyr_2.3.2                 
## [105] png_0.1-8                     parallel_4.3.0               
## [107] ellipsis_0.3.2                blob_1.2.4                   
## [109] sparseMatrixStats_1.12.0      bitops_1.0-7                 
## [111] viridisLite_0.4.2             scales_1.2.1                 
## [113] purrr_1.0.1                   crayon_1.5.2                 
